        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    ...
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/sibo.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/sibo.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">シボヘール</a>
                        </span>
                    </p>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/wild.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/wild.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">ワイルドマンゴーの力</a>
                        </span>
                    </p>
                </th>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/bise.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/bise.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">ビセラ</a>
                        </span>
                    </p>
                </th>
