          ...
          <tbody>
            ...
            <tr>
              ...
              <th>
                ...
                <p>
                  <a class="link-img" target="_blank" href="https://bi-navi.com/links/kon.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
                ...
                <p>
                  <span class="lbg">
                  <a target="_blank" href="https://bi-navi.com/links/kon.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">コンブチャクレンズ</a>
                  </span>
                </p>
              ...
              <th>
                <p>
                  <a class="link-img" target="_blank" href="https://bi-navi.com/links/beru.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
                    <img src="./img/bel.jpg" alt="" />
                  </a>
                </p>
                <p>
                  <span class="lbg">
                    <a target="_blank" href="https://bi-navi.com/links/beru.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">ベルタ酵素</a>
                  </span>
                </p>
              </th>
