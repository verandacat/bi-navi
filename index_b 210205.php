    ...
    <table class="table-01" cellspacing="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <p>
                  <a class="link-img" target="_blank" href="./links/laku.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                ...
                <p>
                  <span class="lbg">
                  <a target="_blank" href="./links/laku.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">Lakubi</a>
                  </span>
                </p>
                ...
                <th>
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="./links/bise.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">ビセラ</a>
                        </span>
                    </p>
                </th>
                ...
                <th>
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="./links/beqtto.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">リキュット</a>
                        </span>
                    </p>
                </th>
            ...
            <tr>
              ...
              <td>
                <p>・体内環境整えるだけでなく、脂肪も燃焼させた・デブ菌を減らし、ヤセ菌を増やしたい</p>
              </td>
          ...
          <p>初回500円</p>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td>
                    <a target="_blank" href="./links/laku.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
