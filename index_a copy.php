  ...
  <table class="table-01" cellspacing="1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
              <img src="./img/slilin.jpg" alt="" />
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">スリリンW</a>
            </span>
          </p>
        </th>
      ...
      <tr class="btn" style="height: 50px;">
        ...
        <td>
          <a target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>
...
<section id="section-04">
  ...
  <ul class="tabs">
    <li class="active red" rel="tab1" onclick="rank_bn.src='./img/n_img/ranking-banner-pc.png'">総合<br>ランキング</li>
