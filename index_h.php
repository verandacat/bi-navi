                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/bouhu.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/bouhu.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">生漢煎「防風通聖散」</a>
                        </span>
                    </p>
                </th>
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/eg.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/eg.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">EGタイトLight</a>
                        </span>
                    </p>
                </th>
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/tsumura.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/tsumura.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">ツムラ漢方防風通聖散</a>
                        </span>
                    </p>
                </th>
            </tr>
