...
<section id="section-02">
     ...
     <tbody>
       ...
       <tr>
         ...
         <th>
           <p>
             <a class="link-img" target="_blank" href="./links/meta.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
         ...
         <th>
           <p>
             <a class="link-img" target="_blank" href="./links/slilin.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
               <img src="./img/slilin.jpg" alt="" />
             </a>
           </p>
           <p>
             <span class="lbg">
               <a target="_blank" href="./links/slilin.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">スリリンW</a>
             </span>
           </p>
         </th>
       ...
       <tr>
         ...
         <td>
         <p class="left ml-5">・手ごろな価格で体内フローラサプリを試したい<br>・食べる前に２粒ダケ！脂肪や糖の吸収も抑えたい</p>
         </td>
...
<div class="img-wrap">
     <img id="rank_bn" src="./img/n_img/ranking-banner-pc-m.png"/>
 </div>
...
<!----------------------------RANKING-------------------------->
   ...
   <section id="section-04">
         ...
         <ul class="tabs">
           ...
           <li class="active" rel="tab4" onclick="rank_bn.src='./img/n_img/ranking-banner-pc-m.png'">糖質ケア<br>サプリ</li>
...
<!-- <section id="section-05">
          ...
          <div class="last-container">
            ...
            <p>当サイトでご紹介している糖質ケアサプリは、効果はもちろんですが、
                    ...
                    <a target="_blank" href="./links/meta.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>" target="_blank">
