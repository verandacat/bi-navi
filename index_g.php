        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/yorisou.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/yorisou.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">わたしとよりそうスムージー</a>
                        </span>
                    </p>
                </th>
...
<section id="section-04">
    ...
    <ul class="tabs">
        ...
        <li class="active" rel="tab7" onclick="rank_bn.src='./img/n_img/ranking-banner-pc-g.png'">ダイエット<br>スムージー</li>
...
<section id="section-05">
    ...
    <div class="last-container">
        ...
        <div class="last-txt bg-wh border-r">
            ...
            <p>ダイエットスムージランキング第１位の<a target="_blank" href="links/gold.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>"
