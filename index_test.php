            ...
            <tbody>
                ...
                <tr>
                    ...
                    <th>
                        ...
                        <p>
                            <a class="link-img" target="_blank"
                                href="https://bi-navi.com/links/kon.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
                        ...
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="https://bi-navi.com/links/kon.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">コンブチャクレンズ</a>
                            </span>
                        </p>
                    ...
                    <th>
                        <p>
                            <a class="link-img" target="_blank"
                                href="https://bi-navi.com/links/beru.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">
                        ...
                        <p>
                            <span class="lbg">
                                <a target="_blank"
                                    href="https://bi-navi.com/links/beru.php<?php echo "?".$_SERVER['QUERY_STRING'] ?>">ベルタ酵素</a>
                            </span>
                        </p>
                    </th>
        ...
        <div class="last-container">
            ...
            <div class="last-txt bg-wh border-r">
                ...
                <p>当サイトでご紹介している酵素サプリは、効果はもちろんですが、
                    <span class="bold">できるかぎり多くの「痩せたい」「ファスティングをしたい」「毎朝すっきりしたい」とお悩みの方に試していただきたい</span>という気持ちから、
