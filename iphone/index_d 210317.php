<?php include('header.php'); ?>
        ...
        <section id="section-01">
            ...
            <div class="title-wrap center">
                ...
                <h1>本当におすすめ！<br>厳選糖質ケアサプリランキング<br>ベスト５を大公開！</span></h1>
      ...
      <div class="img-wrap">
          <img id="rank_bn" src="./img/n_img/ranking-banner-sp-m.png"/>
      </div>
    ...
    <!----------------------------RANKING-------------------------->
        ...
        <div class="swiper-container">
                <ul class="swiper-wrapper tabs">
                  ...
                  <li class="tab4 swiper-slide active"><a href="#tab4" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-m.png'">糖質ケア<br>サプリ</a></li>
