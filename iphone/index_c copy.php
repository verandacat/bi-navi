  ...
  <table class="table-01" cellspacing="1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="https://bi-navi.com/links/berunama.php<?php echo "?" . $query2; ?>">
              <img src="./img/belta.jpg" alt="" />
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="https://bi-navi.com/links/berunama.php<?php echo "?" . $query2; ?>">ベルタこうじ<br>生酵素</a>
            </span>
          </p>
        </th>
      ...
      <tr>
        ...
        <td>
          <p style="text-align: left">
            ・脂肪を燃焼させたい<br>・多少高くても安心の医薬品でしっかりダイエットしたい
          </p>
        </td>
