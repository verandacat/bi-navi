        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="./links/lakubi_plus.php<?php echo "?" . $query2; ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="./links/lakubi_plus.php<?php echo "?" . $query2; ?>">Lakubi</a>
                        </span>
                    </p>
                </th>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td>
                    <a target="_blank" href="./links/lakubi_plus.php<?php echo "?" . $query2; ?>">
                        <img src="./img/n_img/btn_site_go_s.png" width="100%">
                    </a>
                </td>
