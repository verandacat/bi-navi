    ...
    <table class="table-01" cellspacing="1">
        ...
        <tbody>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td>
                    <a target="_blank" href="https://bi-navi.com/links/bouhu.php<?php echo "?" . $query2; ?>">
                ...
                <td>
                    <a target="_blank" href="https://bi-navi.com/links/tsumura.php<?php echo "?" . $query2; ?>">
                        <img src="./img/n_img/btn_site_go_s.png" width="100%">
                    </a>
                </td>
            </tr>
