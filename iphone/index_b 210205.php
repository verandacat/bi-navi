        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    ...
                    <p>
                        <a class="link-img" target="_blank" href="./links/laku.php<?php echo "?" . $query2; ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank" href="./links/laku.php<?php echo "?" . $query2; ?>">Lakubi</a>
                        </span>
                    </p>
                ...
                <th>
                    ...
                    <p>
                        <a class="link-img" target="_blank" href="./links/bise.php<?php echo "?" . $query2; ?>">
                            <img src="./img/bise.jpg" alt="">
                        </a>
                    </p>
                    <p>
                        <span class="lbg">
                            <a target="_blank" href="./links/bise.php<?php echo "?" . $query2; ?>">ビセラ</a>
                        </span>
                    </p>
                </th>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank" href="./links/beqtto.php<?php echo "?" . $query2; ?>">
                            <img src="./img/beqtto.jpg" alt="" />
                        </a>
                    </p>
                    <p>
                        <span class="lbg">
                            <a target="_blank" href="./links/beqtto.php<?php echo "?" . $query2; ?>">リキュット</a>
                        </span>
                    </p>
                </th>
                ...
                <!-- <th>
                            <p>
                              <a class="link-img" target="_blank" href="./links/kuro.php<?php echo "?" . $query2; ?>">
                                <img src="./img/kuro.jpg" alt="" />
                              </a>
                            </p>
                            <p>
                              <span class="lbg">
                                <a target="_blank" href="./links/hoko.php<?php echo "?" . $query2; ?>">くろしろ</a>
                              </span>
                            </p>
                          </th> -->
            </tr>
          ...
          <p>初回500円</p>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td>
                    <a target="_blank" href="./links/laku.php<?php echo "?" . $query2; ?>">
                ...
                <td style="width:28%">
                    <a target="_blank" href="./links/beqtto.php<?php echo "?" . $query2; ?>">
                        <img src="./img/n_img/btn_site_go_s.png" width="100%">
                    </a>
                </td>
                ...
                <!-- <td style="width:28%">
                              <a target="_blank" href="./links/kuro.php<?php echo "?" . $query2; ?>">
                                <img src="./img/n_img/btn_site_go_s.png" width="100%">
                              </a>
                          </td> -->
...
<div class="img-wrap">
    <img id="rank_bn" src="./img/n_img/ranking-banner-sp-b.png" />
</div>
