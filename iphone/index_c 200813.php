...
<section id="section-01">
    ...
    <div class="txt-wrap">
        ...
        <p><span class="bold bg-y">【失敗しないダイエットサプリの正しい選び方】</span>と<span
        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    ...
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/sibo.php<?php echo "?" . $query2; ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/sibo.php<?php echo "?" . $query2; ?>">シボヘール</a>
                        </span>
                    </p>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/wild.php<?php echo "?" . $query2; ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/wild.php<?php echo "?" . $query2; ?>">ワイルドマンゴーの力</a>
                        </span>
                    </p>
                </th>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="https://bi-navi.com/links/bise.php<?php echo "?" . $query2; ?>">
                    ...
                    <p>
                        <span class="lbg">
                            <a target="_blank"
                                href="https://bi-navi.com/links/bise.php<?php echo "?" . $query2; ?>">ビセラ</a>
                        </span>
                    </p>
                </th>
            ...
            <tr>
                ...
                <td>
                    <p style="text-align: left;">
                        ・体重、体脂肪、中性脂肪を減らしたい人<br>・まだワイルドマンゴーを試したことがない<br>・機能性表示食品を試したい
                    </p>
                </td>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td style="width:27%;">
                    <a target="_blank" href="https://bi-navi.com/links/wild.php<?php echo "?" . $query2; ?>">
                        <img src="./img/n_img/btn_site_go_s.png" width="100%">
                    </a>
                </td>
