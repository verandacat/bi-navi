  ...
  <table class="table-01" cellspacing="1">
    ...
    <tbody>
      ...
      <tr>
        ...
        <th>
          <p>
            <a class="link-img" target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $query2; ?>">
              <img src="./img/slilin.jpg" alt="" />
            </a>
          </p>
          <p>
            <span class="lbg">
              <a target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $query2; ?>">スリリンW</a>
            </span>
          </p>
        </th>
      ...
      <tr class="btn" style="height: 50px;">
        ...
        <td>
          <a target="_blank" href="https://bi-navi.com/links/slilin.php<?php echo "?" . $query2; ?>">
            <img src="./img/n_img/btn_site_go_s.png" width="100%">
          </a>
        </td>
