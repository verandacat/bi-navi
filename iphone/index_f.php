                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <th>
                            ...
                            <p>
                              <a class="link-img" target="_blank" href="https://bi-navi.com/links/gold.php<?php echo "?".$query2; ?>">
                            ...
                            <p>
                              <span class="lbg">
                              <a target="_blank" href="https://bi-navi.com/links/gold.php<?php echo "?".$query2; ?>">シボヘールGOLDスムージー</a>
                              </span>
                            </p>
                          ...
                          <th>
                            ...
                            <p>
                              <a class="link-img" target="_blank" href="https://bi-navi.com/links/dark.php<?php echo "?".$query2; ?>">
                                <img src="./img/dark.png" alt="">
                              </a>
                            </p>
                            <p>
                                <span class="lbg">
                                  <a target="_blank" href="https://bi-navi.com/links/dark.php<?php echo "?".$query2; ?>">ダーククレンズ</a>
                                </span>
                            </p>
                          </th>
                          ...
                          <th>
                            <p>
                              <a class="link-img" target="_blank" href="https://bi-navi.com/links/1day.php<?php echo "?".$query2; ?>">
                                <img src="./img/1day.png" alt="" />
                              </a>
                            </p>
                            <p>
                              <span class="lbg">
                                <a target="_blank" href="https://bi-navi.com/links/1day.php<?php echo "?".$query2; ?>">ワンデークレンズ</a>
                              </span>
                            </p>
                          </th>
                          ...
                          <!-- <th>
                            ...
                            <p>
                              <a class="link-img" target="_blank" href="https://bi-navi.com/links/yuu.php<?php echo "?".$query2; ?>">
                                <img src="./img/yuko.jpg" alt="">
                              </a>
                            </p>
                            <p>
                                <span class="lbg">
                                  <a target="_blank" href="https://bi-navi.com/links/yuu.php<?php echo "?".$query2; ?>">優光泉</a>
                                </span>
                            </p>
                          </th> -->
                        ...
                        <tr class="btn" style="height: 50px;">
                          ...
                          <td>
                              <a target="_blank" href="https://bi-navi.com/links/1day.php<?php echo "?".$query2; ?>">
                                <img src="./img/n_img/btn_site_go_s.png" width="100%">
                              </a>
                          </td>
        ...
        <section id="section-04">
               ...
               <div class="swiper-container">
                    <ul class="swiper-wrapper tabs">
                      ...
                      <li class="tab4 swiper-slide"><a href="#tab4" onclick="rank_bn.src='./img/n_img/ranking-banner-sp-m.png'">糖質ケア<br>サプリ</a></li>
