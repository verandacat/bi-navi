...
<style>
  ...
  <div id="wrapper">
      ...
      <div class="keto-wrap">
        ...
        <div class="img">
          <a class="move" href="https://bi-navi.com/links/keto.php<?php echo "?".$query2; ?>">
        ...
        <a class="keto-link" target="_blank" href="https://bi-navi.com/links/keto.php<?php echo "?".$query2; ?>">＞
