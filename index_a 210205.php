        ...
        <tbody>
            ...
            <tr>
                ...
                <th>
                    <p>
                        <a class="link-img" target="_blank"
                            href="./links/lakubi_plus.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                    ...
                    <p>
                        <span style="font-size:13px" class="lbg">
                            <a target="_blank"
                                href="./links/lakubi_plus.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">Lakubi</a>
                        </span>
                    </p>
                </th>
            ...
            <tr class="btn" style="height: 50px;">
                ...
                <td>
                    <a target="_blank" href="./links/lakubi_plus.php<?php echo "?" . $_SERVER['QUERY_STRING'] ?>">
                        <img src="./img/n_img/btn_site_go_s.png" width="100%">
                    </a>
                </td>
